...
function ToastContent({ className, ...props }: ToastPrimitive.Content.Props) {
  return (
    <ToastPrimitive.Content
      ...
      className={cn(
        "flex h-full items-center gap-4 overflow-hidden p-5 transition-opacity duration-250 ease-[cubic-bezier(0.22,1,0.36,1)] data-behind:opacity-0 data-expanded:opacity-100",
        className
      )}
      {...props}
    />
...
function ToastAction({
  className,
  render = <Button variant="default" className="h-11 px-6 text-base" />,
  ...props
